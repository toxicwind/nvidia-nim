...
This model is not owned or developed by NVIDIA. This model has been developed and built to a third-party’s requirements for this application and use case; see link to the [Granite-8B-Code-Instruct  Model Card](https://huggingface.co/ibm-granite/granite-8b-code-instruct).
